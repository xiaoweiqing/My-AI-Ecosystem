...
if not defined command_args (
    echo.
    color 0E :: 错误提示依然使用醒目的亮黄色，这个设计很好，予以保留。
...
echo [3/4] 正在启动 Python 主程序 (da.py)...
echo       AI正在分析数据，请稍候...
echo ------------------------------------------------------
echo.

python d.py %command_args%
