# ==============================================================================
#                 人才分析报告AI (Talent Report AI) v4.2-ProLayout
#                    (Professional Layout Enhanced)
# ==============================================================================
# 版本说明:
# - 【严格遵守】完全保留v4.2版本的所有核心分析功能和表格生成逻辑。
# - 【排版升级】为生成的Word报告正文段落，自动应用“两端对齐”格式，使其像书籍一样整齐、美观。
# - 【最终稳定】这是基于你最认可的内容版本，进行的最终排版优化。
# ==============================================================================
...
def setup_environment():
    print("--- 启动准备工作 (v4.2 专业排版版) ---")
    os.makedirs('output', exist_ok=True)
    os.makedirs('resumes', exist_ok=True)
    print("  - 输出与简历目录已确认。")

# --- 1. 【升级】Word报告生成器 (加入专业排版) ---
...
def process_data_and_generate_narratives(gemini_model, jd_text, df_notion, resumes_text):
    ...
    chapters_prompts = [
        ...
        {"title": "必备技能 vs. 高价技能评估", "prompt": f"这张表格对比了两类技能的覆盖情况。请深入分析这揭示了我们招聘策略的哪些问题？\n\n{tables.get('must_have_vs_high_value', pd.DataFrame()).to_markdown()}"},
